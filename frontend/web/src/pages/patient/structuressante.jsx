...
export default function StructuresSante({ darkMode }) {
  ...
  const structures = data[onglet].filter(
    (s) =>
  ...
  return (
    <div className={`p-4 min-h-screen ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      {/* Barre de recherche */}
      <div
        className={`flex items-center gap-2 rounded-xl px-4 py-3 shadow-sm mb-6 border
      ...
      <div className="flex flex-col gap-4">
        {structures.map((structure) => (
          ...
          >
            {/* Icône */}
            <div
              className={`w-14 h-14 rounded-2xl ${couleurs[onglet].bg} flex items-center justify-center flex-shrink-0`}
            >
