      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className={`rounded-2xl shadow p-5 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
            ...
            <div className="flex flex-col gap-3">
              {[
                { label: "Available Beds", value: "12/50", color: "text-green-500" },
                { label: "Emergencies", value: "3", color: "text-red-500" },
                { label: "Planned Operations", value: "5", color: "text-blue-500" },
                { label: "Discharges Today", value: "8", color: "text-purple-500" },
              ].map((item, index) => (
