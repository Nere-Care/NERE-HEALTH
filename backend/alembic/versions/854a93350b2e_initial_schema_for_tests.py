...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'en_attente'::public.statut_compte"),
            nullable=False,
        ),
        ...
        sa.Column(
            "theme",
            postgresql.ENUM("clair", "sombre", "auto", name="theme_interface"),
            server_default=sa.text("'clair'::public.theme_interface"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'in_app'::public.canal_notification"),
            nullable=False,
        ),
        sa.Column(
            "statut",
            postgresql.ENUM(
                ...
                "echoue",
                "expire",
                name="statut_notification",
            ),
            server_default=sa.text("'en_attente'::public.statut_notification"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_notifications_statut", "notifications", ["statut"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'Inconnu'::public.groupe_sanguin_enum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'logout'::public.token_revoke_reason"),
            nullable=False,
        ),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("ARRAY['fr'::text]"),
            nullable=False,
        ),
        sa.Column(
            "tarif_consultation",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'video'::public.type_consultation"),
            nullable=False,
        ),
        sa.Column(
            "recurrence",
            ...
            server_default=sa.text("'hebdomadaire'::public.recurrence_enum"),
            nullable=False,
        ),
        sa.Column(
            "date_debut_validite",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'en_attente'::public.statut_rdv"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_rendez_vous_date_heure_debut",
        "rendez_vous",
        ["date_heure_debut"],
        unique=False,
    )
    op.create_index(
        "ix_rendez_vous_medecin_id",
        "rendez_vous",
        ["medecin_id"],
        unique=False,
    )
    op.create_index(
        "ix_rendez_vous_patient_id",
        "rendez_vous",
        ["patient_id"],
        unique=False,
    )
    op.create_index(
        "ix_rendez_vous_structure_id",
        "rendez_vous",
        ["structure_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'faible'::public.niveau_urgence"),
            nullable=False,
        ),
        sa.Column(
            "redirection_rdv",
    ...
    op.create_index(
        "ix_chatbot_sessions_medecin_id",
        "chatbot_sessions",
        ["medecin_id"],
        unique=False,
    )
    op.create_index(
        "ix_chatbot_sessions_patient_id",
        "chatbot_sessions",
        ["patient_id"],
        unique=False,
    )
    op.create_index(
        "ix_chatbot_sessions_rdv_cree_id",
        "chatbot_sessions",
        ["rdv_cree_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_consultations_rdv_id", "consultations", ["rdv_id"], unique=False
    )
    op.create_table(
        "conversations",
        sa.Column(
        ...
        sa.Column(
            "nb_messages_non_lus_patient",
            sa.Integer(),
            server_default=sa.text("0"),
            nullable=False,
        ),
        sa.Column(
            "nb_messages_non_lus_medecin",
            sa.Integer(),
            server_default=sa.text("0"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_conversations_rdv_id", "conversations", ["rdv_id"], unique=False
    )
    op.create_table(
        "paiements",
        sa.Column(
    ...
    op.create_index(
        "ix_paiements_medecin_id", "paiements", ["medecin_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text("'texte'::public.type_message"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_ordonnances_consultation_id",
        "ordonnances",
        ["consultation_id"],
        unique=False,
    )
    op.create_index(
        "ix_ordonnances_medecin_id",
        "ordonnances",
        ["medecin_id"],
        unique=False,
    )
    op.create_index(
        "ix_ordonnances_patient_id",
        "ordonnances",
        ["patient_id"],
        unique=False,
    )
